...
namespace Engage.Dnn.Publish
{
    ...
    public class Setting
    {
        ...
        public static readonly Setting ArticleSettingCurrentDisplay = new Setting("ArticleSettings", "DisplayOnCurrentPage");
                                       // , "Automatically include other articles from the same Article List(s).");
        public static readonly Setting ArticleSettingForceDisplay = new Setting("ArticleSettings", "ForceDisplayOnPage");

        public static readonly Setting ArticleSettingIncludeCategories = new Setting("ArticleSettings", "IncludeParentCategoryArticles");
                                       // , "Whether or not the display will include parent categories in the display.");
        ...
        public static readonly Setting EmailAFriend = new Setting("pnlEmailAFriend", "Visible");
                                       // , "Hide/Show the Email a Friend link on the module");
        public static readonly Setting ForumComments = new Setting("chkForumComments", "Checked");

        public static readonly Setting PrinterFriendly = new Setting("pnlPrinterFriendly", "Visible");
                                       // , "Hide/Show the printer friendly link on the module");
        ...
        public static readonly Setting UseApprovals = new Setting("chkUseApprovals", "Checked");
                                       // , "If checked, approval workflow is disabled for this item.");
        ...
        private Setting(string controlName, string propertyName)
        {
            // , string description)
        ...
        public override string ToString()
        {
            ...
            builder.Append(this._controlName);
            builder.Append(" Property Name: ");
            builder.Append(this._propertyName);
            builder.Append(" Property Value: ");
            builder.Append(this._propertyValue);
