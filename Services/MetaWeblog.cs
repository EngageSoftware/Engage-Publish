            ...
            if (ui != null)
            {
                ...
                if (pc.Count > 0)
                {
                    ...
                    Article a = Article.Create(
                        post.title, post.description, post.description, ui.UserID, pc[0].ItemId, pc[0].ModuleId, pc[0].PortalId);
                ...
                throw new XmlRpcFaultException(0, Localization.GetString("PostCategoryFailed.Text", this.LocalResourceFile));
            }
                    ...
                    var ci = new CategoryInfo
                        {
                            ...
                            htmlUrl = UrlGenerator.GetItemLinkUrl((int)dr["ItemId"], PortalId, (int)dr["DisplayTabId"], (int)dr["ModuleId"]), 
