...
namespace Engage.Dnn.Publish.Data
{
    public class SqlDataProvider : DataProvider
    {
        ...
        {
            StringBuilder sql = new StringBuilder(256);
            sql.Append("select [name], itemId, CreatedDate, AuthorUserId, u.DisplayName, LastUpdated, Ltrim(str(itemId)) + '-' + [name] as 'listName' from ");
            sql.Append(NamePrefix);
        ...
        public override DataSet GetItems(int parentItemId, int portalId, int relationshipTypeId, int otherRelationshipTypeId, int itemTypeId)
        {
            ...
            sql.Append(" select ");
            sql.Append(" c.[Name], c.[Description], c.ItemId, c.ItemVersionId, c.ItemTypeId, c.CreatedDate, c.LastUpdated, c.Thumbnail, c.StartDate, c.AuthorUserId, u.DisplayName, c.ApprovedItemVersionID ");
            sql.Append(" from ");
            sql.Append(NamePrefix);
        ...
        public override DataSet GetParentItems(int itemId, int portalId, int relationshipTypeId)
        {
            ...
            sql.Append(" select i.Name, i.Description, i.itemId, i.LastUpdated, i.Thumbnail, i.itemVersionId ");
            sql.Append("from  ");
            sql.Append(NamePrefix);
        ...
        public override DataTable GetAllChildrenNLevels(int parentCategoryId, int nLevels, int mItems, int portalId)
        {
            ...
            sql.Append(" order by  gcil.[Level], vi.ItemTypeId desc, vpar.[Name], vi.[Name] ");
        ...
        public override DataSet GetItemVersions(int itemId, int portalId)
        {
            ...
            sql.Append("select ItemVersionId, DisplayTabId, Name, Description, AuthorUserId, approvalStatusId, StartDate, EndDate, adminType, VersionNumber, ItemVersionDate ");
            sql.Append("from ");
            sql.Append(NamePrefix);
        ...
        public override DataTable GetArticles(int portalId)
        {
            ...
            sql.Append("select name, itemId, ArticleText, DisplayTabID, IsCurrentVersion, Disabled, Description, MetaKeywords, MetaDescription, MetaTitle, AuthorUserId, LastUpdated, ModuleId, ItemIdentifier, ItemIdentifier ");
            sql.Append("from ");
            sql.Append(NamePrefix);
            sql.Append("vwArticles ");
            sql.Append("where PortalID = ");
        ...
        public override DataTable GetArticlesByModuleId(int moduleId)
        {
            ...
            sql.Append("select name, itemId, ArticleText, DisplayTabID, PortalId, IsCurrentVersion, Disabled, Description, MetaKeywords, MetaDescription, MetaTitle, AuthorUserId, LastUpdated, ModuleId, ItemIdentifier, ItemIdentifier, ItemVersionId ");
            sql.Append("from ");
            sql.Append(NamePrefix);
            sql.Append("vwArticles ");
            sql.Append("where ModuleId = ");
        ...
        public override DataTable GetArticlesSearchIndexingNew(int portalId, int displayTabId)
        {
            ...
            sql.Append("select 	name, va.itemId, ArticleText, DisplayTabID, IsCurrentVersion, Disabled, va.Description, MetaKeywords, MetaDescription, MetaTitle, AuthorUserId, LastUpdated, va.PortalId ");
            sql.Append("from ");
            sql.Append(NamePrefix);
        ...
        {
            SqlHelper.ExecuteNonQuery(ConnectionString, NamePrefix + "spUpdateVenexusBrainDump", itemId, indexTitle, indexContent, indexWashedContent, portalId, indexUrl);
        }
        ...
        public override DataTable GetChildrenInCategory(int categoryId, int childTypeId, int maxItems, int portalId, string sortOrder)
        {
            ...
            sql.Append("il.ChildItemId, il.Thumbnail, il.CategoryName, il.ChildName, il.ChildDescription, il.ChildItemTypeId, il.StartDate, il.LastUpdated, il.CreatedDate, il.AuthorUserId, u.DisplayName ");
            sql.Append("from ");
            sql.Append(NamePrefix);
        ...
        public override DataTable GetMostPopular(int categoryId, int childTypeId, int maxItems, int portalId)
        {
            ...
            sql.Append(" il.ChildDescription, il.ChildItemId, il.ChildItemTypeId, il.Thumbnail, il.StartDate, il.AuthorUserId ");
			sql.Append("from ");
			sql.Append(NamePrefix);
            sql.Append("vwItemListing il");
            sql.Append(" join ");
        ...
        {
            return SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "DnnForge_SimpleGallery_AlbumGet", albumId);
        }
        ...
        public override DataTable GetSimpleGalleryPhotos(int albumId, int? maxCount)
        {
            ...
            using (IDataReader dr = GetSimpleGalleryAlbum(albumId))
            {
                if (dr.Read())
                {
            ...
            if (version != null)
            {
                ...
                return SqlHelper.ExecuteDataset(ConnectionString, DatabaseOwner + ObjectQualifier + "DnnForge_SimpleGallery_PhotoList", parameters).Tables[0];
            }
        ...
        {
            return SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "BizModules_UPG_AlbumList", moduleId, -1);
        }

        private IDataReader GetUltraMediaGalleryAlbum(int albumId)
        {
            return SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "BizModules_UPG_AlbumGet", albumId);
        }

        public override DataTable GetUltraMediaGalleryPhotos(int albumId, int? maxCount)
        {
            using (IDataReader dr = GetUltraMediaGalleryAlbum(albumId))
            {
                if (dr.Read())
                {
                    DataTable photos = SqlHelper.ExecuteDataset(ConnectionString, DatabaseOwner + ObjectQualifier + "BizModules_UPG_PhotoList", albumId, true).Tables[0];
